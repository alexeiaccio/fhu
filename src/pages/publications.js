...
function PublicationsPage({ data, location }) {
  ...
  const publications = propPathOr([], ['publications', 'edges'], data)
  ...
  return (
    <Layout>
      <Seo
        ...
        pathname={pathname}
      />
      <h1 css={headingStyles}>Publications</h1>
...
export const PageQuery = graphql`
  query PublicationsQuery {
    ...
    publications: allPrismicText(
      filter: { tags: { regex: "/publications/i" } }
